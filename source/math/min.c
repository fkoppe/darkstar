...
uintmax_t dark_min_umax(const uintmax_t a_, const uintmax_t b_)
{
    //a_
    //b_
...
size_t dark_min_zu(const uintmax_t a_, const uintmax_t b_)
{
    //a_
    //b_
...
int64_t dark_min_imax(const intmax_t a_, const intmax_t b_)
{
    //a_
    //b_
