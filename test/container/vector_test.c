...
int main()
{
    ...
    DARK_TEST_INT(DARK_DARRAY_FRONT(darray_3, int) == 42, DARK_DARRAY_FRONT(darray_3, int));
    DARK_TEST_INT(DARK_DARRAY_BACK(darray_3, int) == 99, DARK_DARRAY_BACK(darray_3, int));
    DARK_TEST(*DARK_DARRAY_DATA(darray_3, int) == DARK_DARRAY_FRONT(darray_3, int));
    ...
    DARK_TEST(DARK_DARRAY_FRONT(darray_1, int) == DARK_DARRAY_BACK(darray_1, int));
    DARK_TEST(DARK_DARRAY_FRONT(darray_2, int) == DARK_DARRAY_BACK(darray_2, int));

    DARK_TEST_INT(DARK_DARRAY_FRONT(darray_1, int) == 8, DARK_DARRAY_FRONT(darray_1, int));
    DARK_TEST_INT(DARK_DARRAY_FRONT(darray_2, int) == 8, DARK_DARRAY_FRONT(darray_2, int));

    DARK_TEST_INT(DARK_DARRAY_FRONT(darray_3, int) == 42, DARK_DARRAY_FRONT(darray_3, int));
    DARK_TEST_INT(DARK_DARRAY_BACK(darray_3, int) == 8, DARK_DARRAY_BACK(darray_3, int));

    DARK_TEST_UINT(dark_darray_capacity(darray_1) == 1, dark_darray_capacity(darray_1));
    DARK_TEST_UINT(dark_darray_capacity(darray_2) == 10, dark_darray_capacity(darray_2));
    DARK_TEST_UINT(dark_darray_capacity(darray_3) == 10, dark_darray_capacity(darray_3));
    DARK_TEST_UINT(dark_darray_size(darray_1) == 1, dark_darray_size(darray_1));
    DARK_TEST_UINT(dark_darray_size(darray_2) == 1, dark_darray_size(darray_2));
    DARK_TEST_UINT(dark_darray_size(darray_3) == 3, dark_darray_size(darray_3));
    ...
    DARK_TEST_INT(DARK_DARRAY_AT(darray_1, 1, int) == 8, DARK_DARRAY_AT(darray_1, 1, int));
    ...
    DARK_TEST_INT(DARK_DARRAY_AT(darray_1, 5, int) == 33, DARK_DARRAY_AT(darray_1, 5, int));
    DARK_TEST_INT(DARK_DARRAY_AT(darray_1, 6, int) == 44, DARK_DARRAY_AT(darray_1, 6, int));
    ...
    DARK_TEST_UINT(dark_darray_capacity(darray_1) == 8, dark_darray_capacity(darray_1));
    DARK_TEST_UINT(dark_darray_size(darray_1) == 7, dark_darray_size(darray_1));

    dark_darray_pop(darray_1, 0, 2);

    DARK_TEST_UINT(dark_darray_capacity(darray_1) == 8, dark_darray_capacity(darray_1));
    DARK_TEST_UINT(dark_darray_size(darray_1) == 5, dark_darray_size(darray_1));

    dark_darray_shrink_to_fit(darray_1);

    DARK_TEST_UINT(dark_darray_capacity(darray_1) == 5, dark_darray_capacity(darray_1));
    DARK_TEST_UINT(dark_darray_size(darray_1) == 5, dark_darray_size(darray_1));

    dark_darray_reserve_exact(darray_1, 22);

    DARK_TEST_UINT(dark_darray_capacity(darray_1) == 22, dark_darray_capacity(darray_1));
    DARK_TEST_UINT(dark_darray_size(darray_1) == 5, dark_darray_size(darray_1));
    ...
    DARK_TEST_UINT(dark_darray_capacity(darray_1) == 6, dark_darray_capacity(darray_1));
    DARK_TEST_UINT(dark_darray_size(darray_1) == 6, dark_darray_size(darray_1));
    ...
    DARK_TEST_UINT(dark_darray_capacity(darray_1) == 6, dark_darray_capacity(darray_1));
    DARK_TEST_UINT(dark_darray_size(darray_1) == 0, dark_darray_size(darray_1));

    DARK_TEST_UINT(dark_darray_element_size(darray_1) == sizeof(int), dark_darray_element_size(darray_1));
