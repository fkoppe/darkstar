...
int main()
{
    ...
    //----------TEST----------
    DARK_TEST("sat_add_zu")
    {
        DARK_TEST_EQ_U(dark_sat_add_zu(0, -1), 0);
        DARK_TEST_EQ_U(dark_sat_add_zu(SIZE_MAX, 10), SIZE_MAX);

        DARK_TEST_EQ_U(dark_sat_add_zu(0, 0), 0);
        DARK_TEST_EQ_U(dark_sat_add_zu(SIZE_MAX - 1, 1), SIZE_MAX);
        DARK_TEST_EQ_U(dark_sat_add_zu(255, -30), 225);
    }
    //--------------------------
    ...
    //----------TEST----------
    DARK_TEST("sat_uadd_zu")
    {
        DARK_TEST_EQ_U(dark_sat_uadd_zu(SIZE_MAX, 10), SIZE_MAX);

        DARK_TEST_EQ_U(dark_sat_uadd_zu(0, 0), 0);
        DARK_TEST_EQ_U(dark_sat_uadd_zu(SIZE_MAX - 1, 1), SIZE_MAX);
    }
    //--------------------------
    ...
    //----------TEST----------
    DARK_TEST("sat_iadd_zu")
    {
        DARK_TEST_EQ_U(dark_sat_iadd_zu(-1, -1), 0);
        DARK_TEST_EQ_U(dark_sat_iadd_zu(66, 10), 76);

        DARK_TEST_EQ_U(dark_sat_iadd_zu(0, 0), 0);
        DARK_TEST_EQ_U(dark_sat_iadd_zu(-200, 201), 1);
    }
    //--------------------------
