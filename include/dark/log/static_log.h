...
void dark_static_log_cbuffer(const Dark_Library* library, const char* module, const char* unit, const char* name, Dark_Log_Format lformat, Dark_Log_Level level, void* ostream, void* ostream_mutex, Dark_Cbuffer cbuffer);
