...
DARK_NORETURN void dark_terminate(const char* file, const char* func, intmax_t line, const char* date, const char* time, const Dark_Library* library, const char* configuration, const char* module, const char* unit, int64_t code, const Dark_Error* error, bool abort_is, const char* message);
